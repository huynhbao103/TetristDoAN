...
import GameMode1.Main.GamePanel;
import GameMode1.Main.Keyhandler;
import GameMode1.Main.PlayManager;
...
public class Mino {
	...
	public void checkMovenmentCollision() {
		leftCollision = false;
	...
	public void update() {
	 ...
	 public void deactivating() {
		 ...
		 if(deactivateCounter == 45  ) {
			 deactivateCounter=0;
			 checkMovenmentCollision();// check  if the bottom  is still  hitting 
